...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2023 a las 10:38:33
...
CREATE TABLE `instructor` (
  ...
  `telefono_in` int(50) NOT NULL,
  `telefono_eme_in` int(50) NOT NULL,
...
(1, 'er', 'ere', 23, 'as@gmail.com', 1234512345, 1234512345, '07-06-2023', '0'),
(2, 'as', 'as', 12, 'fr', 1234567890, 1234567890, '07-06-2023', '0');
...
--
ALTER TABLE `instructor`
  MODIFY `id_instructor` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
