...
public class TarifasCrear extends JPanel {
	...
	public TarifasCrear(JFrame ventana) {
		this.frame=ventana;
        ...
        JButton editarTarifa = new JButton("Crear Tarifa");
        ...
        JTextField ingreDuracion = new JTextField();
        ...
        JTextField ingrePrecio = new JTextField();
        ...
        JButton cambiar_foto = new JButton("Ingresar foto");
