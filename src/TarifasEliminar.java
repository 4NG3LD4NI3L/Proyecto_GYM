...
public class TarifasEliminar extends JPanel {
	...
	public TarifasEliminar(JFrame ventana) {
		this.frame=ventana;
        ...
        JButton editarTarifa = new JButton("Eliminar Tarifa");
        ...
        JLabel etiqueDuracion = new JLabel("Duración: 1 mes");
        ...
        JLabel etiquePrecio = new JLabel("Precio: 300");
        ...
        JLabel etiqueReferencia = new JLabel("Imagen de referencia",JLabel.CENTER);
        etiqueReferencia.setSize(240, 150);
        etiqueReferencia.setLocation(30, 120);
        etiqueReferencia.setFont(new Font("Arial",Font.BOLD,16));
        etiqueReferencia.setForeground(Color.BLACK);
        etiqueReferencia.setBackground(Color.white);
        etiqueReferencia.setOpaque(true);
        panel.add(etiqueReferencia);
